...
namespace UAS_PV_20_06 {
    ...
    public partial class CafeDataSet : global::System.Data.DataSet {
        ...
        public partial class menuDataTable : global::System.Data.TypedTableBase<menuRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public menuRow AddmenuRow(string namamenu, decimal price, int stock) {
            ...
            private void InitClass() {
                ...
                this.columnnamamenu.MaxLength = 30;
            }
...
namespace UAS_PV_20_06.CafeDataSetTableAdapters {
    ...
    public partial class menuTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[menu] WHERE (([menu_id] = @Original_menu_id) AND ((@IsNull_namamenu = 1 AND [namamenu] IS NULL) OR ([namamenu] = @Original_namamenu)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_stock = 1 AND [stock] IS NULL) OR ([stock] = @Original_stock)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[menu] ([namamenu], [price], [stock]) VALUES (@namamenu, @price" +
                ", @stock);\r\nSELECT menu_id, namamenu, price, stock FROM menu WHERE (menu_id = SC" +
                "OPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[menu] SET [namamenu] = @namamenu, [price] = @price, [stock] = @stock WHERE (([menu_id] = @Original_menu_id) AND ((@IsNull_namamenu = 1 AND [namamenu] IS NULL) OR ([namamenu] = @Original_namamenu)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_stock = 1 AND [stock] IS NULL) OR ([stock] = @Original_stock)));
SELECT menu_id, namamenu, price, stock FROM menu WHERE (menu_id = @menu_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT menu_id, namamenu, price, stock FROM dbo.menu";
        ...
        public virtual int Delete(int Original_menu_id, string Original_namamenu, global::System.Nullable<decimal> Original_price, global::System.Nullable<int> Original_stock) {
        ...
        public virtual int Insert(string namamenu, global::System.Nullable<decimal> price, global::System.Nullable<int> stock) {
            if ((namamenu == null)) {
        ...
        public virtual int Update(string namamenu, global::System.Nullable<decimal> price, global::System.Nullable<int> stock, int Original_menu_id, string Original_namamenu, global::System.Nullable<decimal> Original_price, global::System.Nullable<int> Original_stock, int menu_id) {
            if ((namamenu == null)) {
            ...
            if ((Original_namamenu == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_namamenu));
            }
            if ((Original_price.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string namamenu, global::System.Nullable<decimal> price, global::System.Nullable<int> stock, int Original_menu_id, string Original_namamenu, global::System.Nullable<decimal> Original_price, global::System.Nullable<int> Original_stock) {
            return this.Update(namamenu, price, stock, Original_menu_id, Original_namamenu, Original_price, Original_stock, Original_menu_id);
        }
    }
